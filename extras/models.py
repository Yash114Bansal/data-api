...
from search.models import Startup, DirectInvestment
...
class OtherCompanyInfoDirectInvestments(models.Model):
    # Basic Information

    startup = models.OneToOneField(DirectInvestment, on_delete=models.SET_NULL,blank=True, null=True)
    age_of_company = models.PositiveIntegerField(
        help_text="Number of years since the company was founded.", blank=True, null=True
    )
    founders_and_team = models.TextField(
